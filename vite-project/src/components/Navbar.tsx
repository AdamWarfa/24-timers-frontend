      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-950">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href="#" className="flex items-center">
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Competition Logs</span>
          </a>
          <div className="flex items-center lg:order-2">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "text-white bg-blue-700 rounded-lg px-4 py-2 mr-2"
